...
module.exports = ({ cache, config }) => {
  ...
  exports.downloadAsset = async (req, res) => {
    ...
    const api_url = `https://api.github.com/repos/${account}/${repository}/releases/assets/${asset}`
    proxyPrivateDownload({ api_url }, req, res)
  }
    ...
    if (compare(latest.version, version) !== 0) {
      ...
      send(res, 200, {
        ...
        url: shouldProxyPrivateDownload
          ...
          : `https://${latest.platforms[platform].url}`
      })
