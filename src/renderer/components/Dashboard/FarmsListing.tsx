...
import { LaunchArgs, NewSelection } from '@main/util/constants';
            ...
            >
                {sortedByStatus.length > 0 && (
                    <div
                        ...
                        className={clsx(
                            'flex gap-2 overflow-x-hidden overflow-y-auto scrollbar-thin scrollbar-thumb-rounded-lg scrollbar-track-rounded-lg scrollbar-thumb-pepper-300 scrollbar-track-pepper-300/30 flex-col-reverse max-h-[300px]',
                            {
                                'pr-2': overflow
                            }
                        )}
