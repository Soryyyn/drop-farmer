...
/**
 * Overwatch League farm.
 */
export class OverwatchLeague extends GameFarmTemplate {
    gameName: string = "overwatch-league";
    checkerWebsite: string = "https://overwatchleague.com/en-us/";
    schedule: number = 30;
